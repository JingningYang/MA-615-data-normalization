...
"ultorg" can be identified by the combination of "Fecoccemp" and "orgname". "amount" can be identified by "date", "cycle" and "contrib". "recipid" be identified by "recipient". "party" and "recipcode" identified by "recipient"."cmteid" identified by "recipient". "fectransid" is unique independent. 
...
```
For database, please download the attached file: jingning.splite
